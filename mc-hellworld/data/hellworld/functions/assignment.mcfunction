...
execute in minecraft:plunder run tp @e[team=Wonder,type=minecraft:player,scores={hasDied=1}] 0 50 0
...
execute in minecraft:blunder run tp @e[team=Plunder,type=minecraft:player,scores={hasDied=2}] 0 50 0
...
execute in minecraft:thunder run tp @e[team=Blunder,type=minecraft:player,scores={hasDied=3}] 0 50 0
...
execute in minecraft:under run tp @e[team=Thunder,type=minecraft:player,scores={hasDied=4}] 0 50 0
